#!/usr/bin/env python3
"""
Neural Style Transfer class with final image generation
"""
import numpy as np
...
class NST:
    ...
    def generate_image(self, iterations=1000, step=None, lr=0.01,
        ...
        if lr <= 0:
            raise ValueError("lr must be a positive")
        ...
        # Generasiya edilən şəkli content şəkli ilə başladırıq
        generated_image = tf.Variable(self.content_image)

        # Adam optimallaşdırıcısını qururuq
