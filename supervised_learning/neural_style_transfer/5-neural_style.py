#!/usr/bin/env python3
"""
Module to calculate Neural Style Transfer total style cost
"""
import numpy as np
...
class NST:
    ...
    def style_cost(self, style_outputs):
        ...
        Returns:
            total_style_cost: tf.Tensor containing the total style cost
        """
        ...
        # Hər bir qat üçün fərdi üslub itkisini toplayırıq
        ...
        # Çəkilər bərabər paylandığı üçün (cəmi 1 olmaqla) qat sayına bölürük
